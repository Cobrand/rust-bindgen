...
pub fn kind_to_str(x: CXCursorKind) -> &'static str {
    match x {
        ...
        // CXCursorKind::FirstDecl => "FirstDecl",
        // CXCursorKind::LastDecl => "LastDecl",
        CXCursorKind::FirstRef => "FirstRef",
        // CXCursorKind::ObjCSuperClassRef => "ObjCSuperClassRef",
        ...
        // CXCursorKind::LabelRef => "LabelRef",
        CXCursorKind::OverloadedDeclRef => "OverloadedDeclRef",
        CXCursorKind::VariableRef => "VariableRef",
        // CXCursorKind::LastRef => "LastRef",
        CXCursorKind::FirstInvalid => "FirstInvalid",
        // CXCursorKind::InvalidFile => "InvalidFile",
        CXCursorKind::NoDeclFound => "NoDeclFound",
        CXCursorKind::NotImplemented => "NotImplemented",
        CXCursorKind::InvalidCode => "InvalidCode",
        // CXCursorKind::LastInvalid => "LastInvalid",
        CXCursorKind::FirstExpr => "FirstExpr",
        // CXCursorKind::UnexposedExpr => "UnexposedExpr",
        ...
        // CXCursorKind::LastExpr => "LastExpr",
        CXCursorKind::FirstStmt => "FirstStmt",
        // CXCursorKind::UnexposedStmt => "UnexposedStmt",
        ...
        // CXCursorKind::LastStmt => "LastStmt",
        CXCursorKind::TranslationUnit => "TranslationUnit",
        CXCursorKind::FirstAttr => "FirstAttr",
        // CXCursorKind::UnexposedAttr => "UnexposedAttr",
        ...
        // CXCursorKind::LastAttr => "LastAttr",
        ...
        // CXCursorKind::MacroInstantiation => "MacroInstantiation",
        CXCursorKind::InclusionDirective => "InclusionDirective",
        //CXCursorKind::FirstPreprocessing => "FirstPreprocessing",
        //CXCursorKind::LastPreprocessing => "LastPreprocessing",
...
pub fn type_to_str(x: CXTypeKind) -> &'static str {
    match x {
        ...
        // CXTypeKind::FirstBuiltin => "FirstBuiltin",
        // CXTypeKind::LastBuiltin => "LastBuiltin",
